    ...
    public class HomeController : BaseController
    {
        ...
        public ActionResult JoinQuery()
        {
            ...
            foreach (var item in props)
            {
                ...
                #region 折叠代码
                if (NameSpace == "DapperMvc.DataModel")
                {
                    Name = item.Name;
                }
                #endregion
            ...
            var result = connection.Query<Product, Users, Product>(sql, (product, users) =>
            {
        ...
        public ActionResult Test()
        {
            ...
            //string path = "DapperMvc.DataModel." + TableName + ",DapperMvc";
