...
namespace DapperMvc.Controllers
{
    public class AdminController : BaseController
    {
        ...
        public ActionResult ManagerMenu()
        {
            ...
            ViewData["listAllMenu"] = new JavaScriptSerializer().Serialize(listAllMenu).ToLower();
            return View();
        }
        ...
        public ActionResult EditGridData(OT_GridData data)
        {
            ...
            int i = DapperHelper.CreateInstance().UpdateTable<OT_GridData>(editData, param, "OT_GridData", data);
